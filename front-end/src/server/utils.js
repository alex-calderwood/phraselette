...
function broadcastExcept(msg, client, world) {
  if (msg.type !== "mousemove") {
...
// parsed as JSON.
async function fetchJSONResponse(opts, payloadString) {
